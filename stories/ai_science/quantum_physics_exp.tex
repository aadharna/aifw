...
Whenever a specific experiment produced a non-trivial entangled outcome, % (i.e., entanglement greater than that directly provided by the optical elements), 
...
% Suppose photons have colors (since light particles have a frequency corresponding to color). 
