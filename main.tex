...
Joel Lehman\textsuperscript{3}, Victoria Krakovna\textsuperscript{4}, Jeff Clune\textsuperscript{1,2,5,6\textdagger,*}}
...
\correspondence{aadharna@gmail.com, jclune@gmail.com}
\date{}
...
\input{stories/superhuman/move_37}
...
\input{stories/superhuman/libratus}
...
\input{stories/superhuman/diplomacy}
...
\input{stories/superhuman/foerster_marl}
...
\input{stories/reward_hacking/boat_racing}
...
\input{stories/reward_hacking/smac_shield_regen}
...
\input{stories/reward_hacking/claw_rlhf}
...
\input{stories/reward_hacking/online_paired}
...
\input{stories/reward_hacking/cyclegan}
...
\input{stories/reward_hacking/pokemon_static}
...
\input{stories/breaking_constraints/hide_and_seek}
...
\input{stories/breaking_constraints/PPGA}
...
\input{stories/breaking_constraints/world_models_ha}
...
\input{stories/breaking_constraints/smac_handoff}
...
\input{stories/breaking_constraints/evolved_radio}
...
\input{stories/breaking_constraints/gpt4_hires_with_help}
...
\input{stories/foundation_models/vpt}
...
\input{stories/foundation_models/small_motif}
...
\input{stories/foundation_models/aces_llm_code}
...
\input{stories/foundation_models/rainbow_teaming}
...
\input{stories/foundation_models/wedding_parties}
...
\input{stories/foundation_models/claude3}
...
\input{stories/ai_science/tokamak}
...
\input{stories/ai_science/funsearch}
...
\input{stories/ai_science/ai_scientist}
...
\input{stories/ai_science/quantum_physics_exp}
